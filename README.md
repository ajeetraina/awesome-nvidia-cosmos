...
| [NVIDIA Makes Cosmos WFMs Openly Available to Developers](https://blogs.nvidia.com/blog/cosmos-world-foundation-models/) | NVIDIA Blog | Announcement of open availability of the Cosmos world foundation models for robotics and AV developers |
| [Building a Synthetic Motion Generation Pipeline for Humanoid Robot Learning](https://developer.nvidia.com/blog/building-a-synthetic-motion-generation-pipeline-for-humanoid-robot-learning/) | NVIDIA Blog | Using Cosmos Transfer to generate large photorealistic datasets for humanoid robot learning from few demos |
| [Major Release of Cosmos WFMs and Physical AI Data Tools](https://nvidianews.nvidia.com/news/nvidia-announces-major-release-of-cosmos-world-foundation-models-and-physical-ai-data-tools) | NVIDIA Newsroom | Announcement of new Cosmos WFMs plus physical-AI data tools for synthetic data and multimodal reasoning |
| [Cosmos Predict 2.5 & Transfer 2.5: Evolving the WFMs for Physical AI](https://huggingface.co/blog/nvidia/cosmos-predict-and-transfer2-5) | Hugging Face | Introduces the unified Cosmos Predict 2.5 and Transfer 2.5 world foundation models |
| [Fine-Tuning Cosmos Predict 2.5 with LoRA/DoRA for Robot Video Generation](https://huggingface.co/blog/nvidia/cosmos-fine-tuning-for-robot-video-generation) | Hugging Face | Parameter-efficient LoRA/DoRA adaptation of Cosmos Predict 2.5 for robot manipulation video |
| [Post-Train NVIDIA Cosmos 3 in One Day Using Agent Skills](https://developer.nvidia.com/blog/post-train-nvidia-cosmos-3-in-one-day-using-agent-skills/) | NVIDIA Blog | Fine-tuning Cosmos 3 for video question-answering with TAO agent skills and LoRA |
